...
```{r}
setwd("/Users/edwar/Dropbox/Vivesi2017/Analysis/Segmentation/Viv_Segmentation/")
libs <- c("momentuHMM", "lubridate", "data.table", "zoo", "move", "dplyr", "adehabitatLT", "smoove", "doParallel", "foreach", "maptools", "sp", "caret", "robustbase", "here", "plyr", "gbm", "MASS", "mixtools", "knitr","mapdata", "ggplot2", "scales", "gplots", "ggsignif", "ggpubr", "ggsci")
...
load("/Users/edwar/Dropbox/Vivesi2017/Analysis/Segmentation/Viv_Segmentation/lands.robj")

Viv2015_audio <- read.csv("C:/Users/edwar/Dropbox/Vivesi2015/vivesi_tracks/Movebank/Audio/viv2015audio_tracks.csv")
...
# png(file = "/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/BACC_FPT_thresholds.png", width = 600, height = 400)
...
png(filename = "Seg_Viv_FPT.png", width = 800, height = 600)
...
png(filename = "HMM2_pr.png", width = 800, height = 600)
plotPR(m2_15)
dev.off()
jarque_bera(m2_15)
...
png(filename = "HMM2_vs_3.png", width = 800, height = 600)
boxplot(BACC_HMM$HMM2, BACC_HMM$HMM3, names = c("HMM2", "HMM3"))
dev.off()
...
lines(Coast)
lines(Islands)
legend("topright", legend = c("Buzz", "HMM2"), pch = c(8,1), col = c(2, "orange"))
...
lines(Coast)
lines(Islands)
legend("topright", legend = c("Buzz", "HMM3"), pch = c(8,1), col = c(2, "orange"))
...
#pdf(file = "Smoove_Vivesi_20180321_UCVCP_noCW_AIC.pdf")
i = 8
j = 1
for(i in 1:length(bats)){
  bat <- V[V$bat_flight == bats[i],]
...
save(Bats, phaseTables, batPhases, Bat, T, batSweep, Z.cols, cols, batCP.table, Vint, V, v, vint, m2_15,  file = paste0("CVCP_Vivesi_DT_", DT, ".robj"))
```

```{r}
DT = 15
load(paste0("CVCP_Vivesi_DT_", DT, ".robj"))
...
png(filename = "EMbC_BACC.png", width = 800, height = 600)
...
png(filename = "/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/VSeg_FigS2.png", width = 800, height = 600)
...
(230+21*2)/sum(Final$buzz) # 42.0 %

table(Final$buzz, Final$embc01)
(282+26*2)/sum(Final$buzz) # 51.5%

table(Final$buzz, Final$FPT01)
(379+30*2)/sum(Final$buzz) # 67.7%

table(Final$buzz, Final$HMM01)
(411+32*2)/sum(Final$buzz) # 73.3%

table(Final$buzz, Final$CVCP01)
(374+29*2)/sum(Final$buzz) # 66.7%
...
png(filename = "/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/VSeg_Fig4_boxplot_letters.png", width = 800, height = 600)
sizes <- 22
...
# Fig3 Boxplot
```{r}
png(filename = "/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/VSeg_Fig3_boxplot_letters.png", height = 600, width = 800)
...
png(filename = "Time_to_next_buzz.png", width = 800, height = 600)
...
# save data
```{r}
save(Final, Bats, Viv2015_audio, V, Vint, va.traj, m2_15, m3_15, threshold, HMM_data, hmm_mat, TNR_buzz, BA_buzz, TNR_buzz, TNR_buzz_mlt, TPR_buzz, TPR_buzz_mlt, BACC_buzz, BACC_buzz_mlt, TPR_TNR_plot, BACC_plot, sum_BACC, sum_search, fspeed, fturn, cspeed, cturn, file = "VSeg_Buzz_18.robj")

# 'ACC', 'chain_length', 'chain_length_mlt', 'chain_TPR', 'chain_TPR_mlt', 'n_chains', 'n_chains_mlt'

load("VSeg_Buzz_18.robj")
```
...
write.csv(buzz_rate, file = "buzz_rate.csv")
...
# setwd("/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/")
## width: 800, height: 862

png(filename = "/Users/edwar/Dropbox/Vivesi2018/Documents/Segmentation/MovementEcology/Revisions/VSeg_Fig5_v6.png", width = 800, height = 900)
...
# Kendall's tau correlation between search chain length and number of buzzes contained within each chain
```{r}
cor.test(embc_Chain$length[embc_Chain$value == 1], embc_Chain$buzz[embc_Chain$value == 1], method = "kendall")
plot(embc_Chain$length[embc_Chain$value == 1], embc_Chain$buzz[embc_Chain$value == 1], type = "o", col = rgb(0,0,0,.1))

cor.test(FPT_Chain$length[FPT_Chain$value == 1], FPT_Chain$buzz[FPT_Chain$value == 1], method = "kendall")

cor.test(HMM_Chain$length[HMM_Chain$value == 1], HMM_Chain$buzz[HMM_Chain$value == 1], method = "kendall")
cor.test(CVCP_Chain$length[CVCP_Chain$value == 1], CVCP_Chain$buzz[CVCP_Chain$value == 1], method = "kendall")
```



```{r}
cor.test(Final$embc01, Final$buzz, method = "kendall")
cor.test(Final$FPT01, Final$buzz, method = "kendall")
cor.test(Final$HMM01, Final$buzz, method = "kendall")
cor.test(Final$CVCP01, Final$buzz, method = "kendall")
```
...
# where are Final and Viv2015_audio different?
```{r}
sum(Final$buzz)
table(Final$buzz)
...
fbats <- unique(Final$bat_flight)
vbats <- unique(Viv2015_audio$Individual)
```
